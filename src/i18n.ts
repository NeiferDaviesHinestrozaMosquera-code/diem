...
const translationFR = {
  ...
  'slide2.title': 'Solutions Pilotées par l\'IA',
  'slide2.subtitle': 'Automatisation intelligente pour votre entreprise',
  'slide2.description': "Exploitez la puissance de l'intelligence artificielle pour optimiser les opérations.",

  'slide3.title': 'Excellence en E-Commerce',
  'slide3.subtitle': 'Construisez votre empire en ligne',
  'slide3.description': 'Solutions e-commerce complètes qui convertissent les visiteurs en clients.',

  // Home - Features
  whyChooseTitle: 'Pourquoi Choisir Digital Emporium?',
  whyChooseSubtitle: "Nous combinons l'innovation et l'expertise pour offrir des résultats exceptionnels",
  ...
  'feature.performance.desc': 'Optimisé pour la vitesse et la scalabilité',
  ...
  servicesSubtitle: 'Nous offrons une suite complète de services numériques pour élever votre entreprise.',
  viewDetails: 'Voir les détails',

  // Projects
  projectsTitle: 'Nos Projets',
  projectsSubtitle: 'Découvrez les solutions innovantes et les projets impactants que nous avons livrés à nos clients.',
  projectsDetails: 'Voir le Projet',

  // About
  aboutTitle: 'À Propos de Nous',
  aboutSubtitle: 'Découvrez notre histoire et ce qui nous motive.',
  welcomeTitle: 'Bienvenue chez Digital Emporium!',
  welcomeText: "Nous sommes une équipe passionnée de développeurs, designers et spécialistes en IA dédiés à la création de solutions numériques innovantes.",
  mission: 'Mission',
  vision: 'Vision',
  values: 'Valeurs',
  missionText: 'Fournir des solutions numériques exceptionnelles qui stimulent la croissance et le succès de nos clients.',
  visionText: "Être l'entreprise leader en solutions numériques, reconnue pour notre excellence et notre innovation.",
  ...
  'value.innovation': 'Innovation',
  'value.innovation.desc': "Nous repoussons constamment les limites et explorons de nouvelles technologies.",

  'value.passion': 'Passion',
  'value.passion.desc': "Nous aimons ce que nous faisons, et cette passion se traduit par un travail exceptionnel.",

  'value.excellence': 'Excellence',
  'value.excellence.desc': 'Nous maintenons les plus hauts standards dans chaque projet.',

  'value.collaboration': 'Collaboration',
  'value.collaboration.desc': 'Nous travaillons en étroite collaboration avec nos clients.',
  ...
  'contact.schedule.desc': 'Réservez une consultation gratuite pour discuter de vos besoins de projet.',
  ...
  'contact.map.title': 'Siège de Digital Emporium',
  'contact.map.address': '123 Tech Street, San Francisco, CA',
  'contact.map.button': 'Obtenir des Directions',
  ...
  company: 'Nom de la Société (Optionnel)',
  ...
  'quote.help.desc': 'Notre équipe est là pour vous aider à identifier la meilleure solution pour vos besoins.',
  ...
  clientInquiries: 'Demandes clients',
...
const translationDE = {
  ...
  projectsSubtitle: 'Entdecken Sie die innovativen Lösungen und wirkungsvollen Projekte, die wir für unsere Kunden geliefert haben.',
  projectsDetails: 'Projekt ansehen',
  ...
  vision: 'Vision',
  values: 'Werte',
  missionText: 'Außergewöhnliche digitale Lösungen bereitzustellen, die Wachstum und Erfolg für unsere Kunden durch innovative Technologie vorantreiben.',
  visionText: 'Das führende Unternehmen für digitale Lösungen zu sein, anerkannt für unsere Exzellenz und Innovation.',
  ...
  'value.innovation': 'Innovation',
  'value.innovation.desc': 'Wir überschreiten ständig Grenzen und erkunden neue Technologien.',

  'value.passion': 'Leidenschaft',
  'value.passion.desc': 'Wir lieben, was wir tun, und diese Leidenschaft führt zu außergewöhnlicher Arbeit.',

  'value.excellence': 'Exzellenz',
  'value.excellence.desc': 'Wir halten in jedem Projekt die höchsten Standards ein.',

  'value.collaboration': 'Zusammenarbeit',
  'value.collaboration.desc': 'Wir arbeiten eng mit unseren Kunden zusammen.',
  ...
  'contact.schedule.desc': 'Buchen Sie eine kostenlose Beratung, um Ihre Projektanforderungen zu besprechen.',
  ...
  'quote.help.desc': 'Unser Team hilft Ihnen, die beste Lösung für Ihre Bedürfnisse zu finden.',
...
const translationPT = {
  ...
  projectsSubtitle: 'Descubra as soluções inovadoras e os projetos impactantes que entregamos aos nossos clientes.',
  projectsDetails: 'Ver Projeto',
  ...
  vision: 'Visão',
  values: 'Valores',
  missionText: 'Fornecer soluções digitais excepcionais que impulsionam o crescimento e sucesso de nossos clientes.',
  visionText: 'Ser a empresa líder em soluções digitais, reconhecida por nossa excelência e inovação.',
  ...
  'value.innovation.desc': 'Constantemente ultrapassamos limites e exploramos novas tecnologias.',

  'value.passion': 'Paixão',
  'value.passion.desc': 'Amamos o que fazemos, e essa paixão se traduz em trabalho excepcional.',

  'value.excellence': 'Excelência',
  'value.excellence.desc': 'Mantemos os mais altos padrões em cada projeto.',

  'value.collaboration': 'Colaboração',
  'value.collaboration.desc': 'Trabalhamos em estreita colaboração com nossos clientes.',
  ...
  'contact.schedule.desc': 'Marque uma consulta gratuita para discutir as necessidades do seu projeto.',
  ...
  'quote.help.desc': 'Nossa equipe está aqui para ajudá-lo a identificar a melhor solução para suas necessidades.',
